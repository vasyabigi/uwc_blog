...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SimpleSpamProtection'
        db.create_table('blog_simplespamprotection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('answer', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('blog', ['SimpleSpamProtection'])

    def backwards(self, orm):
        # Deleting model 'SimpleSpamProtection'
        db.delete_table('blog_simplespamprotection')
    ...
    models = {
        ...
        'blog.postcomment': {
            ...
            'author': ('django.db.models.fields.CharField', [], {'max_length': '63', 'blank': 'True'}),
            'content': ('django.db.models.fields.TextField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'blog.simplespamprotection': {
            'Meta': {'ordering': "('question',)", 'object_name': 'SimpleSpamProtection'},
